...
},{}],"../../../node_modules/@sabasayer/module.core/dist/module/module.js":[function(require,module,exports) {
"use strict";
...
},{}],"../../../node_modules/@sabasayer/module.core/dist/module/create-module/create-module.js":[function(require,module,exports) {
"use strict";
...
const createModule = () => {
  return new _module.ModuleCore();
};

exports.createModule = createModule;
},{"../module":"../../../node_modules/@sabasayer/module.core/dist/module/module.js"}],"../../../node_modules/@sabasayer/module.core/dist/module/decorators/inject.decorators.js":[function(require,module,exports) {
"use strict";
...
const injectable = new InjectDecorators();
...
var _inject = require("./inject.decorators");

var _resolve = require("./resolve.decorators");
},{"./inject.decorators":"../../../node_modules/@sabasayer/module.core/dist/module/decorators/inject.decorators.js","./resolve.decorators":"../../../node_modules/@sabasayer/module.core/dist/module/decorators/resolve.decorators.js"}],"../../../node_modules/@sabasayer/module.core/dist/module/index.js":[function(require,module,exports) {
"use strict";
...
},{"./module":"../../../node_modules/@sabasayer/module.core/dist/module/module.js","./create-module/create-module":"../../../node_modules/@sabasayer/module.core/dist/module/create-module/create-module.js","./decorators/index":"../../../node_modules/@sabasayer/module.core/dist/module/decorators/index.js"}],"../../../node_modules/@sabasayer/module.core/dist/provider/core-provider.js":[function(require,module,exports) {
"use strict";
...
},{"./url.utils":"../../../node_modules/@sabasayer/module.core/dist/utils/url.utils.js"}],"../../../node_modules/@sabasayer/module.core/dist/index.js":[function(require,module,exports) {
"use strict";
...
const authModule = (0, _module.createModule)();
exports.authModule = authModule;
authModule.useDecorators(_module.injectable, _module.resolve);
...
_module2.authModule.registerHttpClient(_module.FetchHTTPClient, {
...
},{"@sabasayer/module.core":"../../../node_modules/@sabasayer/module.core/dist/index.js","./module":"../src/configurations/module.ts"}],"../src/configurations/index.ts":[function(require,module,exports) {
"use strict";

require("./module");

require("./http-client.boot");
},{"./module":"../src/configurations/module.ts","./http-client.boot":"../src/configurations/http-client.boot.ts"}],"../src/response/base.provider.ts":[function(require,module,exports) {
"use strict";
...
},{"@sabasayer/module.core":"../../../node_modules/@sabasayer/module.core/dist/index.js"}],"../src/auth/auth.config.ts":[function(require,module,exports) {
"use strict";
...
},{}],"../src/auth/auth.provider.ts":[function(require,module,exports) {
"use strict";
...
var _base = require("../response/base.provider");
...
exports.AuthProvider = AuthProvider = __decorate([_module.injectable.provider()], AuthProvider);
},{"@sabasayer/module.core":"../../../node_modules/@sabasayer/module.core/dist/index.js","../response/base.provider":"../src/response/base.provider.ts","./auth.config":"../src/auth/auth.config.ts"}],"../src/auth/auth.controller.ts":[function(require,module,exports) {
"use strict";
...
__decorate([_module.resolve.cache(_module.SessionStorageCache)], AuthController.prototype, "cache", void 0);

__decorate([_module.resolve.client()], AuthController.prototype, "httpClient", void 0);

exports.AuthController = AuthController = __decorate([_module.injectable.controller({
  provider: _auth.AuthProvider
})], AuthController);
},{"@sabasayer/module.core":"../../../node_modules/@sabasayer/module.core/dist/index.js","./auth.provider":"../src/auth/auth.provider.ts"}],"../src/tenant/tenants.config.ts":[function(require,module,exports) {
"use strict";
...
},{}],"../src/tenant/tenant.provider.ts":[function(require,module,exports) {
"use strict";
...
__decorate([_module.resolve.cache(_module.SessionStorageCache)], TenantProvider.prototype, "cache", void 0);

exports.TenantProvider = TenantProvider = __decorate([_module.injectable.provider()], TenantProvider);
},{"@sabasayer/module.core":"../../../node_modules/@sabasayer/module.core/dist/index.js","../response/base.provider":"../src/response/base.provider.ts","./tenants.config":"../src/tenant/tenants.config.ts"}],"../src/tenant/tenant.controller.ts":[function(require,module,exports) {
"use strict";
...
exports.TenantController = TenantController = __decorate([_module.injectable.controller({
  provider: _tenant.TenantProvider
})], TenantController);
},{"@sabasayer/module.core":"../../../node_modules/@sabasayer/module.core/dist/index.js","./tenant.provider":"../src/tenant/tenant.provider.ts"}],"../src/index.ts":[function(require,module,exports) {
"use strict";
...
var _module = require("./configurations/module");

var _tenant = require("./tenant/tenant.controller");
...
main();
},{"./configurations":"../src/configurations/index.ts","./auth/auth.controller":"../src/auth/auth.controller.ts","./configurations/module":"../src/configurations/module.ts","./tenant/tenant.controller":"../src/tenant/tenant.controller.ts"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
